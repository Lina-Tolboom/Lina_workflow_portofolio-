...
p_act_humans = plot_activities_human("Kenya", c(2, 24), "gedeelde_code/PNG_human_patterns.csv")
...
# Sla de gereproduceerde figuur op
dir.create("resultaten", showWarnings = FALSE)

ggsave(
  filename = "resultaten/figuur_2_gereproduceerd.png",
  plot = p_fig2,
  width = 11,
  height = 9,
  dpi = 300
